         ...
         <h4>Leia-nos !</h4>
            <article className={styles.blogArticle}>
             ...
             <div className={styles.divisor}></div>
               <article className={styles.blog2Article}>
                  ...
                  <a href="https://viralata-reau.medium.com/como-a-tokeniza%C3%A7%C3%A3o-vai-mudar-definitivamente-a-nossa-realidade-85d9bab0205c" target="_blank">
            ...
            <footer className={styles.footer}>
                <div className={styles.socialMedias}>
                    ...
                    <a href="https://t.me/viralatafinance" target="_blank">
